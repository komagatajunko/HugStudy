...
public class FruitsConstants {
    ...
    // フルーツ定数（個数）
    public static final int FRUITS_COUNT_10 = 10;
    public static final int FRUITS_COUNT_20 = 20;
    public static final int FRUITS_COUNT_45 = 45;
    public static final int FRUITS_COUNT_78 = 78;
    public static final int FRUITS_COUNT_100 = 100;
